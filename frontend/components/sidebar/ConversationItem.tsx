...
export function ConversationItem({
  ...
  return (
    <div
      onClick={() => onSelect(chat.id)}
      className={cn(
        "group relative flex items-center justify-between px-3 py-2.5 rounded-xl cursor-pointer transition-all duration-200 text-left border w-full min-w-0 max-w-full overflow-hidden",
        isActive
        ...
        {isEditing ? (
          ...
          >
            <input
              ...
              autoFocus
              className="w-full bg-[#0d111a] border border-[#6d5dfc] rounded px-1.5 py-0.5 text-xs text-white focus:outline-none min-w-0"
            />
            <button
              onClick={handleSaveRename}
              className="p-1 hover:text-emerald-400 text-zinc-400 cursor-pointer shrink-0"
              title="Save"
            >
            ...
            <button
              ...
              className="p-1 hover:text-red-400 text-zinc-400 cursor-pointer shrink-0"
              title="Cancel"
            >
          ...
          <div className="flex flex-col min-w-0 flex-1 overflow-hidden">
            <span className="text-[13px] font-medium truncate leading-tight block">
              {chat.title}
            </span>
            <span className="text-[11px] text-zinc-500 font-normal mt-0.5 truncate block">
      ...
      {!isEditing && (
        ...
        >
          ...
          <button
            ...
            className="p-1 rounded-md text-zinc-400 hover:text-red-400 hover:bg-red-500/15 transition-colors cursor-pointer"
            title="Delete chat"
          >
